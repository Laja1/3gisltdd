     ...
     <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
       <div className="bg-white shadow-lg rounded-lg overflow-hidden">
         <div className="relative">
           <img src='/images/project/CloudHotspot.jpeg' className="w-full h-80 object-cover" alt="Cloud-Hotspot-Service" />
           <div className="absolute inset-0 bg-gradient-to-b from-transparent to-gray-900 opacity-75"></div>
           <h2 className="absolute inset-x-0 bottom-4 text-center text-white text-2xl font-bold">Cloud Hotspot Service</h2>
         </div>
         <div className="px-6 py-8">
           <p className="text-gray-700 text-sm leading-relaxed">
           This was an ongoing marketing innovation started by Leadway in the country. The project provided free Wi-Fi internet access to National Youth Service Corp (NYSC) candidates at the camps during their 3 weeks orientation into the service. </p>
           
                            <p className="mt-2 text-gray-700  text-sm leading-relaxed">
                  This solution advertised Leadway and its services on the hotspot and captured data of the corpers for follow up after the exercise.</p>
