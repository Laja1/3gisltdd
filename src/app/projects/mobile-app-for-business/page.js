...
export default function Mtn() {
    return (
      <div>
        <Head>
          <title>Mobile App for Business</title>
          <meta name="description" content="Mobile App for Business" />
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="px-6 py-8">
                <p className="text-gray-700 text-sm leading-relaxed">
                  <span className="text-blue-600 font-bold">MTN BizApp</span> is
                  a mobile app developed specifically to cater to Small and
                  Medium Businesses (SMBs) that are subscribed to the MTN
                  network across all its Operating Companies in Africa and the
                  Middle East.
                </p>
                <p className="mt-4 text-gray-700  text-sm leading-relaxed">
                  It is designed to help SMBs leverage Social Media as an online
                  growth strategy and access MTN Services such as the MTN Bulk
