        ...
        <Slider {...settings} className="zubuz-testimonial-slider">
          <div className="zubuz-testimonial-slider-item">
            <div className="zubuz-testimonial-slider-data">
              ...
              {/* <h3 style={{fontSize:30,}}> "A Game Changer for Our Business"</h3> */}
               <p style={{fontSize:30,}} className="text-sm leading-loose  open-sans">
...
We strongly recommend them for your IT and Web Management requirements.    </p>
            </div>
